...
# Modified from Cristina Herren's cohesion method to run on the sludge tags ASV dataset
...
b <- read.csv("data/otu_tables/2019-08-23-DADA2-asv-table.csv", header = T, row.names = 1)
